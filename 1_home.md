...
<div style="background: #8b7da7;">
  <p style="background: #20a5de; font-weight: 300; color: #fff; padding: 15px 0; font-size: 20px;"></p>
</div>
...
<div style="width: 100%; clear: both; float: left; padding-top: 40px; padding-bottom: 40px;">
  <div style="width: 85%; margin: auto;">
    ...
    <div style="padding-left: 20px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="https://media.licdn.com/dms/image/C4E03AQH6BsRuqRHRwQ/profile-displayphoto-shrink_200_200/0?e=1583366400&v=beta&t=LZqiqWliwotTUa_OqAXIR84OlZ6nHrxedIOgFGUCAm4">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        ...
        <span style="font-size: 12px;">Hank Ritter<br>
        Hank.ritter@looker.com</span></p>
      </div>
    </div>

    <div style="padding-left: 40px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="https://media.licdn.com/dms/image/C4E03AQFvsqziBneegg/profile-displayphoto-shrink_200_200/0?e=1583366400&v=beta&t=ZH3f_svO6s16bLM20T7VK1GMS1P7yOBDIumhPBLN4iA">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        <p><span style="font-size: 16px;">Analyst</span><br>
        <span style="font-size: 12px;">John Bennett<br>
        John.bennett@looker.com</span></p>
      </div>
    </div>
